...
extern t_uint32 g_pcSimPwmPulses_au32[FMKIO_OUTPUT_SIGPWM_NB];
extern t_cbFMKIO_PulseEvent *g_pcSimPwmPulseEndCb_apcb[FMKIO_OUTPUT_SIGPWM_NB];
extern t_cbFMKIO_EventFunc *g_pcSimInEvntCb_apcb[PCSIM_DIM_OR_ONE(FMKIO_INPUT_SIGEVNT_NB)];
extern t_eFMKIO_SigTrigCptr g_pcSimInEvntTrigger_ae[PCSIM_DIM_OR_ONE(FMKIO_INPUT_SIGEVNT_NB)];
extern t_bool g_pcSimInEvntConfigured_ab[PCSIM_DIM_OR_ONE(FMKIO_INPUT_SIGEVNT_NB)];
